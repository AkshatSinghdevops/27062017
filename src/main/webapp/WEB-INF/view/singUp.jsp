...
<li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown">Jobs<span class="caret"></span></a>
 ...
 <hr><hr>
      ...
      <div class="generic-container" ng-controller="UserController as ctrl">
                  ...
                  <form ng-submit="ctrl.submit()" name="myForm" class="form-horizontal">
                      ...
                      <div class="row">
                          <div class="form-group col-md-12">
                              ...
                              <div class="col-md-7">
                                  <input type="text" ng-model="ctrl.user.name" id="uname" class="name form-control input-sm" placeholder="Enter your name" required ng-minlength="3"/>
          ...
          <a href="imageupload"><h4>For Uploading Image</h4></a>
         <img src='<c:url value='/static/images/image3.jpg' />'
		align="center" alt="This is image" width="1000" height="250">
