...
public class BlogController {
 ...
 String id=(String)session.getAttribute("loggedInUserID");
  ...
  blog.setCreate_date(new java.util.Date());
	...
	@RequestMapping(value="/list_user_blog",method=RequestMethod.GET)
	public ResponseEntity<java.util.List>  listUserBlog(Model model){
		 String id=(String)session.getAttribute("loggedInUserID");
	   return new ResponseEntity(blogDAO.userbloglist(id),HttpStatus.OK); 
	}
